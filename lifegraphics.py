...
def showgood():
    """Makes the next life_lab8 generation appear"""
    global board
...
running = True
def showgood2():
    """Sets the board to keep moving through generations of life_lab8.
    ...
    if running:
        if board == next_life_generation(board) == \
           next_life_generation(next_life_generation(board)) or allZeroes(board):
            ...
            # between each generation of life_lab8. Set it low (e.g. 0 seconds, or 500
